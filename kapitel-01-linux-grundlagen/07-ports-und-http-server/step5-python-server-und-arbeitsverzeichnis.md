...
`&` ist bekannte Shell-Syntax aus Workshop 5. Sie startet den Prozess im Hintergrund. Der Prompt kehrt zurück, obwohl der Server weiterläuft. Job-Control wird nicht erneut eingeführt.
